@extends('backside.layout.app', ['breadcrumb_heading' => 'Setting Information', 'breadcrumb_sections' => ['Setting Information', 'Assessment Setting', 'Edit']])
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex align-items-center justify-content-between">
                    <h4 class="card-title">Edit Assessment Setting</h4>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group mb-3">
                                    <select name="asmnt_type" id="" class="form-control" required>
                                        <option value="" hidden>Select Assessment Types</option>
